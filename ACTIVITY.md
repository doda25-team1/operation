...
### Week Q2.6 (Dec 15–21)
- Alex: [https://github.com/doda25-team1/operation/pull/22](https://github.com/doda25-team1/operation/pull/39) Updated documentation with a details about strcutre, architecture, components, quick start, kubernetes deployment, istio service mesh, monitoring and using dashboards, configurations
